...
import com.example.demo.Combattant.*;
...
public class GuiParser implements InputParser {
    ...
    public void askNumberHero() {
        try {
            this.controller = this.app.changeScene("/com/example/demo/nbHero.fxml", this);
        }catch (IOException e){
            e.printStackTrace();
        }
    }
    ...
    public void askHeroType(int nbHero) {
        try {
            ...
            this.controller = this.app.changeScene("/com/example/demo/createHeros.fxml",this);
        }catch (IOException e){
            e.printStackTrace();
        }
    ...
    public void annonceFight() {
        try{
            this.app.changeScene("/com/example/demo/annonceFightView.fxml",this);
        }catch (IOException e){
            e.printStackTrace();
        }
    ...
    public void displayDamage(Combattant attacker, Combattant target, int damage) {
        try {
            this.controller = this.app.changeScene("/com/example/demo/damageInformation.fxml",this);
    ...
    public void levelWin() {
        try {
            this.controller = this.app.changeScene("/com/example/demo/levelWinView.fxml",this);
        }catch (IOException e){
            e.printStackTrace();
        }
    }
    ...
    public void choseConsumable(Hero hero) {
        try {
            this.controller = this.app.changeScene("/com/example/demo/choseObjectView.fxml",this);
        }catch (IOException e){
            e.printStackTrace();
        }
    ...
    public void choseTarget(Team enemyTeam) {
        try {
            this.controller = this.app.changeScene("/com/example/demo/choseTargetView.fxml",this);
    ...
    public void choseAction(Combattant combattant) {
        if(combattant instanceof Hero){
            try {
                this.controller = this.app.changeScene("/com/example/demo/choseActionView.fxml",this);
